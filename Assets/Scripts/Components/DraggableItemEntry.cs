...
public class DraggableItemEntry : IconText, IDragSource, IDragTarget
{
    ...
    protected override void Start()
    {
        base.Start();
        if (Data != null)
            Assign(Sprite, Data.name, Data.amount.ToString());
    ...
    public void OnDropComplete(DragPayload payload)
    {
        ...
        Data = data;
        Assign(payload.sprite, data.name, data.amount.ToString());
        SetActive(true);
